...
const dasPrograms = [
  {
    ...
    description:
      "Pelaksanaan pemantauan kualitas air dan laju sedimentasi di 5 daerah aliran sungai prioritas menggunakan metode sampling terpadu selama musim hujan dan kemarau.",
    stats: "5 DAS · 18 titik monitoring · 12,5 ha area rehabilitasi",
  ...
  },
  {
    ...
    category: "DAS",
    title: "Pemetaan Area Kritis di Bantaran Sungai",
    description:
      "Kegiatan pemetaan dilakukan untuk mengidentifikasi titik rawan erosi, sedimentasi tinggi, dan kawasan bantaran sungai yang membutuhkan rehabilitasi vegetasi.",
    stats: "3 DAS · 11 titik rawan · 6,8 ha area prioritas",
    image: "https://placehold.co/700x420",
  },
  {
    id: 3,
    ...
    category: "DAS",
    title: "Pemantauan Kualitas Air Berbasis Komunitas",
    description:
      "Forest Lestari melibatkan relawan dan komunitas lokal untuk melakukan pengamatan kualitas air, dokumentasi perubahan fisik sungai, dan pencatatan kondisi lingkungan.",
    stats: "7 komunitas · 22 relawan · 15 sampel air",
    image: "https://placehold.co/700x420",
  },
  {
    id: 4,
    date: "26 Mei 2025",
    category: "DAS",
    title: "Rehabilitasi Vegetasi Area Riparian",
    description:
      "Program rehabilitasi dilakukan pada area riparian yang mengalami tekanan lingkungan dengan penanaman spesies lokal untuk memperkuat fungsi ekologis DAS.",
    stats: "4,2 km riparian · 320 pohon · 58 relawan",
    image: "https://placehold.co/700x420",
  },
]
      ...
      <section className="border-b border-black/10 bg-[#D9D9D9]">
        <div className="mx-auto max-w-7xl px-6 py-24 sm:py-28 lg:py-32">
          ...
          <h1 className="mt-8 max-w-4xl text-4xl font-bold leading-tight text-emerald-900 sm:text-5xl lg:text-6xl">
            Memantau, memulihkan, dan menjaga daerah aliran sungai
          </h1>

          <p className="mt-8 max-w-3xl text-base leading-relaxed text-zinc-700 sm:text-lg">
            Program DAS Forest Lestari berfokus pada pemantauan kualitas air,
            pengendalian sedimentasi, rehabilitasi area riparian, dan
            pelibatan komunitas lokal dalam perlindungan ekosistem sungai.
          </p>
        </div>
      </section>
                  ...
                  <div className="grid gap-0 lg:grid-cols-[1.3fr_0.7fr]">
                    <div className="flex flex-col justify-center p-6 sm:p-8 lg:p-10">
                      <div className="flex flex-wrap items-center gap-3">
                        ...
                        <span className="rounded-full bg-blue-400 px-3 py-1 text-[10px] font-semibold text-white">
                          {item.category}
                        </span>
                      </div>
                      ...
                      <Link
                        href={`/tentangkami/pencapaian/DAS/${item.id}`}
          ...
          <div className="grid lg:grid-cols-[1.2fr_0.8fr]">
            <div className="p-8 sm:p-10 lg:p-12">
              ...
              <h2 className="mt-4 max-w-2xl text-3xl font-bold leading-tight text-white sm:text-4xl">
                Lihat rekap pemantauan DAS dan rehabilitasi tahunan
              </h2>

              <p className="mt-5 max-w-xl text-sm leading-7 text-white/80">
                Data monitoring DAS, titik pemantauan, area rehabilitasi, dan
                kolaborasi komunitas dikompilasi dalam laporan tahunan Forest
                Lestari.
              </p>
            </div>
