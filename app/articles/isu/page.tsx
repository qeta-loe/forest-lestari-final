...
<div className="w-[1440px] h-[1897px] relative bg-stone-50 overflow-hidden">
  ...
  <div className="w-44 h-9 p-5 left-[604px] top-[168px] absolute bg-stone-50 rounded-[50px] outline outline-1 outline-offset-[-1px] outline-emerald-950 inline-flex justify-center items-center gap-2.5">
    <div className="text-center justify-center text-emerald-900 text-base font-normal font-['Work_Sans']">Berita Komunitas</div>
  </div>
  <div className="w-40 h-9 p-5 left-[195px] top-[168px] absolute bg-gray-300 rounded-[50px] outline outline-1 outline-offset-[-1px] outline-emerald-950 inline-flex justify-center items-center gap-2.5">
  ...
  <div className="w-28 h-5 p-5 left-[402px] top-[287px] absolute bg-stone-50 rounded-[50px] outline outline-1 outline-offset-[-1px] outline-emerald-950 inline-flex justify-center items-center gap-2.5">
  ...
  <div className="w-28 h-5 p-5 left-[760px] top-[1303px] absolute bg-stone-50 rounded-[50px] outline outline-1 outline-offset-[-1px] outline-emerald-950 inline-flex justify-center items-center gap-2.5">
    <div className="text-center justify-center text-emerald-900 text-xs font-normal font-['Work_Sans']">Isu Lingkungan</div>
  </div>
  ...
  <div className="w-28 h-5 p-5 left-[66px] top-[794px] absolute bg-stone-50 rounded-[50px] outline outline-1 outline-offset-[-1px] outline-emerald-950 inline-flex justify-center items-center gap-2.5">
    <div className="text-center justify-center text-emerald-900 text-xs font-normal font-['Work_Sans']">Isu Lingkungan</div>
  </div>
  <div className="w-28 h-5 p-5 left-[66px] top-[1301px] absolute bg-stone-50 rounded-[50px] outline outline-1 outline-offset-[-1px] outline-emerald-950 inline-flex justify-center items-center gap-2.5">
    <div className="text-center justify-center text-emerald-900 text-xs font-normal font-['Work_Sans']">Isu Lingkungan</div>
  </div>
  ...
  <div className="w-28 h-5 p-5 left-[406px] top-[794px] absolute bg-stone-50 rounded-[50px] outline outline-1 outline-offset-[-1px] outline-emerald-950 inline-flex justify-center items-center gap-2.5">
    <div className="text-center justify-center text-emerald-900 text-xs font-normal font-['Work_Sans']">Isu Lingkungan</div>
  </div>
  ...
  <div className="w-28 h-5 p-5 left-[742px] top-[287px] absolute bg-stone-50 rounded-[50px] outline outline-1 outline-offset-[-1px] outline-emerald-950 inline-flex justify-center items-center gap-2.5">
    <div className="text-center justify-center text-emerald-900 text-xs font-normal font-['Work_Sans']">Isu Lingkungan</div>
  </div>
  <div className="w-28 h-5 p-5 left-[742px] top-[287px] absolute bg-stone-50 rounded-[50px] outline outline-1 outline-offset-[-1px] outline-emerald-950 inline-flex justify-center items-center gap-2.5">
    <div className="text-center justify-center text-emerald-900 text-xs font-normal font-['Work_Sans']">Isu Lingkungan</div>
  ...
  <div className="w-28 h-5 p-5 left-[1082px] top-[287px] absolute bg-stone-50 rounded-[50px] outline outline-1 outline-offset-[-1px] outline-emerald-950 inline-flex justify-center items-center gap-2.5">
    <div className="text-center justify-center text-emerald-900 text-xs font-normal font-['Work_Sans']">Isu Lingkungan</div>
  </div>
  <div className="w-28 h-5 p-5 left-[1082px] top-[287px] absolute bg-stone-50 rounded-[50px] outline outline-1 outline-offset-[-1px] outline-emerald-950 inline-flex justify-center items-center gap-2.5">
    <div className="text-center justify-center text-emerald-900 text-xs font-normal font-['Work_Sans']">Isu Lingkungan</div>
  </div>
  <div className="w-28 h-5 p-5 left-[1086px] top-[794px] absolute bg-stone-50 rounded-[50px] outline outline-1 outline-offset-[-1px] outline-emerald-950 inline-flex justify-center items-center gap-2.5">
    <div className="text-center justify-center text-emerald-900 text-xs font-normal font-['Work_Sans']">Isu Lingkungan</div>
  </div>
</div>
</main>
