export default function ArticlesPage() {
  ...
  <div className="w-40 h-9 p-5 left-[398px] top-[168px] absolute bg-gray-300 rounded-[50px] outline outline-1 outline-offset-[-1px] outline-emerald-950 inline-flex justify-center items-center gap-2.5">
  ...
  <div className="w-28 h-5 p-5 left-[403px] top-[287px] absolute bg-stone-50 rounded-[50px] outline outline-1 outline-offset-[-1px] outline-emerald-950 inline-flex justify-center items-center gap-2.5">
    <div className="text-center justify-center text-emerald-900 text-xs font-normal font-['Work_Sans']">Edukasi dan Tips</div>
  </div>
  <div className="w-28 h-5 p-5 left-[743px] top-[287px] absolute bg-stone-50 rounded-[50px] outline outline-1 outline-offset-[-1px] outline-emerald-950 inline-flex justify-center items-center gap-2.5">
    <div className="text-center justify-center text-emerald-900 text-xs font-normal font-['Work_Sans']">Edukasi dan Tips</div>
  </div>
  ...
  <div className="w-28 h-5 p-5 left-[403px] top-[793px] absolute bg-stone-50 rounded-[50px] outline outline-1 outline-offset-[-1px] outline-emerald-950 inline-flex justify-center items-center gap-2.5">
    <div className="text-center justify-center text-emerald-900 text-xs font-normal font-['Work_Sans']">Edukasi dan Tips</div>
  </div>
  ...
  <div className="w-28 h-5 p-5 left-[743px] top-[793px] absolute bg-stone-50 rounded-[50px] outline outline-1 outline-offset-[-1px] outline-emerald-950 inline-flex justify-center items-center gap-2.5">
    <div className="text-center justify-center text-emerald-900 text-xs font-normal font-['Work_Sans']">Edukasi dan Tips</div>
  </div>
  ...
  <div className="w-28 h-5 p-5 left-[1089px] top-[793px] absolute bg-stone-50 rounded-[50px] outline outline-1 outline-offset-[-1px] outline-emerald-950 inline-flex justify-center items-center gap-2.5">
    <div className="text-center justify-center text-emerald-900 text-xs font-normal font-['Work_Sans']">Edukasi dan Tips</div>
  </div>
  <div className="w-28 h-5 p-5 left-[756px] top-[1300px] absolute bg-stone-50 rounded-[50px] outline outline-1 outline-offset-[-1px] outline-emerald-950 inline-flex justify-center items-center gap-2.5">
    <div className="text-center justify-center text-emerald-900 text-xs font-normal font-['Work_Sans']">Edukasi dan Tips</div>
  </div>
  ...
  <div className="w-28 h-5 p-5 left-[1091px] top-[287px] absolute bg-stone-50 rounded-[50px] outline outline-1 outline-offset-[-1px] outline-emerald-950 inline-flex justify-center items-center gap-2.5">
    <div className="text-center justify-center text-emerald-900 text-xs font-normal font-['Work_Sans']">Edukasi dan Tips</div>
  </div>
